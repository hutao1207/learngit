...
#    print "物资编码申请页面失效，测试失败"
    ...
    wzName = "tay" + time.strftime('%Y%m%d%H%M',time.localtime(time.time())) #taf:test-auto-yy
...
#        print "物资编码申请提交失败，请检查，测试失败"
        ...
        trNum = int(browser.find_element_by_xpath("//div[@id='pg_grid-pager']/table/tbody/tr/td[2]/table/tbody/tr/td[8]/select/option[1]").text)
        i = 0
        j = 0
